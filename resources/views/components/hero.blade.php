...
<h1 class="display-6 text-yellow-500 letter-spacing fw-bold text-uppercase text-shadow titolo bodoni">Creazione Siti Web a Roma</h1>
                <h2 class="display-4 fw-bold text-uppercase text-shadow titolo">Trasforma le tue idee in esperienze
                    digitali
                </h2>

                <p class="lead  fs-3 mt-3 text-shadow bodoni letter-spacing">Siti web performanti e su misura per il tuo business.
                </p>

                <a href="#contatti"
                    id="scrollButton" class="btn btn-lg bg-yellow-500 transition delay-150 duration-300 ease-in-out hover:-translate-y-1 hover:scale-110 hover:bg-indigo-500 my-4">
