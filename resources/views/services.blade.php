        ...
        <div class="row text-center align-items-center  justify-content-center">
            ...
            <div class="col-6 d-flex flex-column my-5 align-items-center d-flex justify-content-center">
                ...
                <div>
                    ...
                    <img class="laptop" src="{{ asset('storage/images/laptop-svg.png') }}" alt="">
            ...
            <div class="col-6 d-flex flex-column  align-items-center d-flex justify-content-center">

                <div class="">

                    <img class="prof" src="{{ asset('storage\images\stock-svgrepo-com.svg') }}" alt="">
                </div>
